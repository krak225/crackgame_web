...
io.on('connection', function (socket) {
  ...
  socket.on('send-invitation', function (data) {
	...
	var sql_duel = 'select * from duel inner join users on users.id = duel.user_id where user_id = "'+ data.from_user_id +'" order by duel_id desc limit 0,1';
