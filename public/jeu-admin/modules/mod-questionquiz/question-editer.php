...
//Page générée automatiquement par quickApp V 2.0 :(Copyright: Armand Kouassi, @krak225, krak225@gmail.com, +225 08779408), le 19-05-2019 à 16:22:01  
	$info='<div class="default-info">Renseignez tous les champs puis cliquez sur <b>Valider</b> </div>';
		$user_id=1;$type_jeu_id=2;$question_fr=null;$question_en=null;$proposition_a_fr=null;$proposition_a_en=null;$proposition_b_fr=null;$proposition_b_en=null;$proposition_c_fr=null;$proposition_c_en=null;$reponse=null;$categorie_id=null;$niveau_id=null;$statut_selection="NOT SELECTED";$statut_selection_chap="NOT SELECTED";$statut="BROUILLON";
		...
		if(isset($_POST["add"])){ 
			...
			$x->verifierNombre($niveau_id,"Niveau",0,100000000000000000000000,1);
	
			if($x->ToutEstCorrecte()){  
				$sql='INSERT INTO `question` (type_jeu_id,user_id,question_fr,question_en,proposition_a_fr,proposition_a_en,proposition_b_fr,proposition_b_en,proposition_c_fr,proposition_c_en,reponse,categorie_id,niveau_id,statut_selection,statut_selection_chap,statut) 
				VALUES ("'.$type_jeu_id.'","'.$user_id.'","'.$question_fr.'","'.$question_en.'","'.$proposition_a_fr.'","'.$proposition_a_en.'","'.$proposition_b_fr.'","'.$proposition_b_en.'","'.$proposition_c_fr.'","'.$proposition_c_en.'","'.$reponse.'","'.$categorie_id.'","'.$niveau_id.'","'.$statut_selection.'","'.$statut_selection_chap.'","'.$statut.'")';
				...
				if($stm->execute()){
					...
					$user_id=null;$question_fr=null;$question_en=null;$proposition_a_fr=null;$proposition_a_en=null;$proposition_b_fr=null;$proposition_b_en=null;$proposition_c_fr=null;$proposition_c_en=null;$reponse=null;$categorie_id=null;$niveau_id=null;$statut_selection=null;$statut_selection_chap=null;$statut=null;
				}
				else{
