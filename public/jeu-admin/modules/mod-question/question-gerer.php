...
<div>
	...
	if(isset($_GET["execAction"]))
	{
		...
		foreach($table_id as $id)
		{
			...
			$checkBoxValue=isset($_GET["cfgM".$id])? 1 : 0;//print $checkBoxValue;
		...
		<fieldset>
			<select class="champ" name="user_id" id="user_id" title="User">
				...
				foreach($data as $d51){
					...
					print '<option '.$selected.' value="'.$d51->id.'">'.$d51->pseudo.'</option>';
				}
				?>
			</select>
	...
	<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
		<tr>
			...
			<th class="table-header-options line-left"><a href="">Utilisateur</a></th>
			<th class="table-header-options line-left"><a href="">Fr/En</a></th>
			<th class="table-header-options line-left"><a href="">Categorie</a></th>
			<!--th class="table-header-options line-left"><a href="">Statut_selection</a></th>
			<th class="table-header-options line-left"><a href="">Statut_selection_chap</a></th-->
			<th class="table-header-options line-left"><a href="">Statut</a></th>
			<th class="table-header-options line-left"><a href="">Action</a></th>
		</tr>
		<?php
		$sql='select question.*, categorie.categorie_libelle, users.pseudo, users.nom, users.prenoms from question inner join users on users.id = question.user_id 
		...
		print '<tr id="tr-'.$d->id.'" '.$trclass.'>
			...
			<td title="'.$d->nom.' '.$d->prenoms.'">'.stripslashes($d->pseudo).'</td>
			...
			<!--td>'.stripslashes($d->statut_selection).'</td>
			<td>'.stripslashes($d->statut_selection_chap).'</td-->
