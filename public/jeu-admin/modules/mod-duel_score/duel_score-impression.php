...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(80);
		// Titre
		$this->Cell(30,10,"LISTE DES DUEL_SCORES",2,0,"C");
		// Saut de ligne
		$this->Ln(20);
	}
...
//l'entete
$pdf->Cell(0,8,"",0,1);
$pdf->Cell(63.333333333333,8 ,"Duel", 1, 0, "C",0, "");
$pdf->Cell(63.333333333333,8 ,"User", 1, 0, "C",0, "");
$pdf->Cell(63.333333333333,8 ,"Score", 1, 0, "C",0, "");
$pdf->Cell(63.333333333333,8 ,"Connected", 1, 0, "C",0, "");
...
while($d=mysql_fetch_object($req)){
	// debug($d);
	$pdf->Cell(0,8,"",0,1);
	$pdf->Cell(63.333333333333,8 ,utf8_decode($d->duel_id), 1, 0, "C",0, "");
	$pdf->Cell(63.333333333333,8 ,utf8_decode($d->user_id), 1, 0, "C",0, "");
	$pdf->Cell(63.333333333333,8 ,utf8_decode($d->score), 1, 0, "C",0, "");
	$pdf->Cell(63.333333333333,8 ,utf8_decode($d->connected), 1, 0, "C",0, "");
