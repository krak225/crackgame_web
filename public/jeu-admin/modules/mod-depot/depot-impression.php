...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(80);
		// Titre
		$this->Cell(30,10,"LISTE DES DEPOTS",2,0,"C");
		// Saut de ligne
		$this->Ln(20);
	}
...
while($d=mysql_fetch_object($req)){
	...
	$pdf->Cell(63.333333333333,8 ,utf8_decode($d->depot_montant), 1, 0, "C",0, "");
	$pdf->Cell(63.333333333333,8 ,utf8_decode($d->depot_date), 1, 0, "C",0, "");
