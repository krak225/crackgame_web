<div class="leftbox" id="" style="padding:0px;">
			<div class="blocTitle">DÉTAILS D'UN RETRAIT</div>
...
if(isset($_GET["id"]) and is_numeric($_GET["id"])){
	...
	<label>Montant</label>
	<div><?php print $d->retrait_montant;?></div>
	<label>Date demande</label>
	<div><?php print $d->retrait_date_demande;?></div>
	<label>Date validation</label>
	<div><?php print $d->retrait_date_validation;?></div>
