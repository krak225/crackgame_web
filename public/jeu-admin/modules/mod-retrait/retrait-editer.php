<div class="leftbox" id="" style="padding:0px;">
			<div class="blocTitle">ENREGISTRER UN RETRAIT</div>
	...
	$info='<div class="default-info">Renseignez tous les champs puis cliquez sur <b>Valider</b> </div>';
		...
		if(isset($_POST["add"])){ 
			...
			if($x->ToutEstCorrecte()){  
				$sql='INSERT INTO `retrait` (user_id,retrait_montant,retrait_date_demande,retrait_date_validation) 
				VALUES ("'.$user_id.'","'.$retrait_montant.'","'.$retrait_date_demande.'","'.$retrait_date_validation.'")';
