...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(80);
		// Titre
		$this->Cell(30,10,"LISTE DES DEVISES",2,0,"C");
		// Saut de ligne
		$this->Ln(20);
	}
...
//l'entete
$pdf->Cell(0,8,"",0,1);
$pdf->Cell(95,8 ,"Code", 1, 0, "C",0, "");
$pdf->Cell(95,8 ,"Libelle", 1, 0, "C",0, "");
...
while($d=mysql_fetch_object($req)){
	// debug($d);
	$pdf->Cell(0,8,"",0,1);
	$pdf->Cell(95,8 ,utf8_decode($d->devise_code), 1, 0, "C",0, "");
	$pdf->Cell(95,8 ,utf8_decode($d->devise_libelle), 1, 0, "C",0, "");
