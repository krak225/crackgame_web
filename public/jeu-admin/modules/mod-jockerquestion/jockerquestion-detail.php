<div class="leftbox" id="" style="padding:0px;">
			<div class="blocTitle">DÉTAILS D'UN JOCKERQUESTION</div>
...
if(isset($_GET["id"]) and is_numeric($_GET["id"])){
	...
	<div><?php print $d->jockerquestion_quantite;?></div>
	<label>Montant</label>
	<div><?php print $d->jockerquestion_montant;?></div>
	<label>Date</label>
	<div><?php print $d->jockerquestion_date;?></div>
