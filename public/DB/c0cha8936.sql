...
-- Généré le :  Mar 26 Novembre 2019 à 20:18
...
--
-- Contenu de la table `chap`
--

INSERT INTO `chap` (`chap_id`, `user_id`, `chap_participants`, `chap_vainqueur_id`, `chap_etape`, `chap_date_creation`, `readystate`, `chap_statut`) VALUES
(5, 1, 3, NULL, 1, '2019-11-26 19:59:39', 'NOT READY', 'EN COURS');
...
--
-- Contenu de la table `chap_question`
--
...
--
-- Contenu de la table `chap_score`
--
...
--
-- Contenu de la table `duel_jocker`
--
...
--
-- Contenu de la table `duel_question`
--
...
--
-- Contenu de la table `duel_score`
--
...
--
-- Contenu de la table `jockerquestion`
--
...
(5, 2, 'KOUASSI', 'RICHMOND', 'Masculin', '2018-02-06', '033928442', 'krak225@gmail.com', 'richmond', NULL, NULL, 'Andore', 1, 6, '6.jpg', NULL, 'Français', 'FCFA', 0, 0, 50, 0, 4, 0, 0, 0, 400, 'richmond', '$2y$10$RSLmbj5y8mE4YK/BKsp/6.dSiZzTuqLL3FS564T9lBBJ2fQPA4JMS', 'KuhYYOuIwiI0I7Gbb9YdVzl4WCKYSzDS8A0NYU0OsKSCHc7oTpf91uwDXEMf', NULL, '2019-03-08 22:31:43', '2019-11-26 10:46:08', 'VALIDE', 'ACTIVE', 'ACTIVE', 'Hors matrice', 'DECONNECTE', 'Pro'),
...
--
ALTER TABLE `abonnement`
  MODIFY `abonnement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `cagnotte`
  MODIFY `cagnotte_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `depot`
  MODIFY `depot_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `entrainement`
  MODIFY `entrainement_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `jockerquestion`
--
ALTER TABLE `jockerquestion`
  MODIFY `jockerquestion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `souscription`
  MODIFY `souscription_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
