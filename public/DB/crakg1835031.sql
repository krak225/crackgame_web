...
--
-- Hôte : localhost
-- Généré le : sam. 05 mars 2022 à 04:03
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=0 ROW_FORMAT=COMPACT;
...
(1, 6, 'Quelle est la capitale de la Côte d\'Ivoire?', 'What is the capital of Ivory Coast', 'Abidjan', 'Bouaké', 'Daloa', 'Daloa', 'Yamoussoukro', 'Yamoussoukro', 'C', 7, 1, NULL, 'SELECTED', 'SELECTED', 'VALIDE'),
(2, 6, 'En quelle année la Côte d\'Ivoire a-t-elle obtenu son indépendance?', 'In wich year, Ivory Coast get its independancy?', '1956', '1956', '1960', '1960', '1962', '1962', 'B', 2, 1, NULL, 'SELECTED', 'SELECTED', 'VALIDE'),
(5, 6, 'Quelle est la capitale de la France?', 'What is the capital of France', 'Marseille', 'Marseille', 'Alsace', 'Alsace', 'Paris', 'Paris', 'C', 2, 1, NULL, 'SELECTED', 'SELECTED', 'VALIDE'),
(7, 6, 'Dans l\'industrie cinématographique américaine, que signifie l\'abréviation MGM ?', '', 'Metro Goldwyn Mayer', '', 'Millenium Good Media', '', 'Middle Glass Musics', '', 'A', 7, 1, NULL, 'SELECTED', 'SELECTED', 'VALIDE'),
(8, 10, 'Que signifie ONU?', NULL, 'Organisation Nationale des Universités', NULL, 'Organisation des Nations Unies', NULL, 'Office Nationale de l\'Unité', NULL, 'B', 3, 1, NULL, 'NOT SELECTED', 'SELECTED', 'VALIDE'),
(9, 10, 'Comment appelle t-on la version 5 d\'Android?', NULL, 'Ice cream sandwich', NULL, 'Lolipop', NULL, 'Oreo', NULL, 'B', 4, 1, NULL, 'NOT SELECTED', 'NOT SELECTED', 'VALIDE'),
(10, 6, 'Comment appelle t-on la version 8 d\'Android?', '', 'Ice cream sandwich', '', 'Lolipop', '', 'Oreo', '', 'C', 7, 1, NULL, 'SELECTED', 'NOT SELECTED', 'VALIDE'),
(11, 6, 'Que signifie ONG?', '', 'Organisation Nationale des Gares', '', 'Organisation Non Gouvernementale', '', 'Office Nationale des Gouverneurs', '', 'B', 7, 1, NULL, 'SELECTED', 'NOT SELECTED', 'VALIDE'),
(12, 6, 'Quelle est la formule du poids d\'un objet?', '', 'P = m x g', '', 'P = m + g', '', 'P = m - g', '', 'A', 7, 1, NULL, 'SELECTED', 'NOT SELECTED', 'VALIDE'),
(13, 5, 'Dans quelle pays se trouve le Mont Tonkpi?', '', 'Mali', '', 'Ghana', '', 'Côte d\'Ivoire', '', 'C', 2, 1, NULL, 'SELECTED', 'SELECTED', 'VALIDE'),
(15, 10, 'Que signifie UEMOA?', NULL, 'Unité Electorale Mondiale pour l\'Ordre en Afrique', NULL, 'Union des Electricien du Monde en Afrique', NULL, 'Union Economique et Monetaire Ouest Africaine', NULL, 'C', 2, 1, NULL, 'NOT SELECTED', 'SELECTED', 'VALIDE'),
(16, 10, 'Qeulle est le chef lieu de la région du hambole?', NULL, 'Bouaké', NULL, 'Katiola', NULL, 'Dabakala', NULL, 'B', 2, 1, NULL, 'NOT SELECTED', 'SELECTED', 'VALIDE'),
(17, 10, 'De qui est le roman Les frasques d\'Ebinto?', NULL, 'Isaie Binton Coulibaly', NULL, 'Tidiane Dem', NULL, 'Amadou Koné', NULL, 'C', 1, 1, NULL, 'NOT SELECTED', 'SELECTED', 'VALIDE'),
(18, 10, 'Dans quelle commune se trouve le monument AKWABA en Côte d\'Ivoire?', NULL, 'Koumassi', NULL, 'Port-Bouet', NULL, 'Yopougon', NULL, 'B', 1, 1, NULL, 'NOT SELECTED', 'SELECTED', 'VALIDE'),
(19, 6, 'Qui est l\'auteur de cette phrase : “Je souhaite que la  santé  soit  enfin considérée non plus comme une bénédiction que l’on espère mais comme un droit de l’homme pour lequel on se bat.” ?', '', 'Kofi Annan', '', 'Mahatma Gandhi', '', 'Nelson Mandela', '', 'A', 1, 1, NULL, 'NOT SELECTED', 'SELECTED', 'VALIDE'),
(20, 5, 'Selon le plan comptable SYSCOHADA laquelle de ces affirmations est fausse ?', '', 'Classe 5: comptes de tiers', '', 'Classe 7: comptes de produits Activité Ordinaire', '', 'Classe 1: comptes de ressources durables', '', 'A', 6, 2, NULL, 'SELECTED', 'NOT SELECTED', 'VALIDE'),
(21, 10, 'Selon le plan comptable SYSCOHADA, laquelle de ces classes ne relève pas de la comptabilité générale ?', '', 'Classe 5', '', 'Classe 9', '', 'Classe 8', '', 'B', 6, 2, NULL, 'NOT SELECTED', 'SELECTED', 'VALIDE'),
(22, 5, 'Lequel de ces principes est un principe comptable?', '', 'Le principe de la sincérité', '', 'Le principe de la continuité de l\'exploitation', '', 'Le principe de l\'honnêteté', '', 'B', 6, 2, NULL, 'SELECTED', 'NOT SELECTED', 'VALIDE'),
(23, 5, 'Que signifie TVA ?', '', 'Taux variable d’Authenticité', '', 'Taxe sur  vente  abattue', '', 'Taxe sur la valeur ajoutée', '', 'C', 7, 2, NULL, 'SELECTED', 'NOT SELECTED', 'VALIDE'),
(24, 2, 'Que signifie FRDE en  comptabilité?', '', 'Front de recherche Dana', '', 'Frais de recherche et de développement', '', 'Finir, ralentir et développer', '', 'B', 6, 2, NULL, 'SELECTED', 'NOT SELECTED', 'VALIDE'),
(25, 6, 'Combien de variantes  existe-t-il dans la méthode du coût moyen pondéré ? ', '', '2', '', '4', '', '8', '', 'A', 6, 2, NULL, 'NOT SELECTED', 'SELECTED', 'VALIDE'),
(28, 5, 'Dans quelle commune se trouve le monument AKWABA en Côte d\'Ivoire?', '', 'Port-Bouet', '', 'Koumassi', '', 'Yopougon', '', 'A', 2, 2, NULL, 'SELECTED', 'SELECTED', 'VALIDE'),
(39, 5, 'De quelle nationalité est la chantre Débora Lukalu ?', NULL, 'Sud africaine', NULL, 'Concolaise', NULL, 'Centrafricaine', NULL, 'B', NULL, 2, NULL, 'SELECTED', 'SELECTED', 'BROUILLON'),
(30, 5, 'Qui est le fondateur du PDCI-RDA', '', 'Laurent Gbagbo', '', 'Henri Konan Bédié', '', 'Felix Houphouet Boigny', '', 'C', 2, 2, NULL, 'SELECTED', 'SELECTED', 'VALIDE'),
(31, 5, 'Que signifie BURIDA', '', 'Bureau Ivoirien du Droit des Auteurs', '', 'Bureau Ivoirien du Droit d\'Auteur', '', 'Bureau Ivoirien du Droit d\'Artiste', '', 'B', 7, 2, NULL, 'SELECTED', 'SELECTED', 'VALIDE'),
(32, 10, 'Que signifie ONU?', 'What is UN?', 'Office Nationale pour l\'UnitÃ©', 'Union of Nation', 'Office des Nations Unies', 'Union of Natural', 'Organisation des Nations Unies', 'United Nation', 'C', 2, 2, NULL, 'NOT SELECTED', 'SELECTED', 'VALIDE'),
(33, 2, 'Quel est le double de 28', '', '288', '', '56', '', '82', '', 'B', 8, 2, NULL, 'SELECTED', 'SELECTED', 'BROUILLON'),
(34, 2, 'Quel est la moitié de 256', '', '156', '', '128', '', '123', '', 'B', 8, 2, NULL, 'SELECTED', 'SELECTED', 'BROUILLON'),
(35, 2, 'En quelle année la RCA a-t-elle obtenu son indépendance', '', '1960', '', '1965', '', '1964', '', 'A', 2, 2, NULL, 'SELECTED', 'SELECTED', 'BROUILLON'),
(36, 2, 'Quel est la capitale de la Centrafrique', '', 'Bimbo', '', 'Bangui', '', 'Birao', '', 'B', 2, 2, NULL, 'SELECTED', 'SELECTED', 'BROUILLON'),
(37, 2, 'Quel est le tiers de 300', '', '3', '', '30', '', '100', '', 'C', 7, 2, NULL, 'SELECTED', 'SELECTED', 'BROUILLON'),
(38, 2, 'Quel est le triple de 300', '', '100', '', '900', '', '1', '', 'B', 8, 2, NULL, 'SELECTED', 'NOT SELECTED', 'BROUILLON'),
(40, 1, 'sfsdfs', 'sfds', 'sfsd', 'sfdsf', 'sfds', 'sfds', 'fsfdsf', 'sfdsf', 'A', 1, 2, NULL, 'NOT SELECTED', 'NOT SELECTED', 'BROUILLON');
...
(5, 2, 'KOUASSI', 'RICHMOND', 'Masculin', '2018-02-06', '033928442', 'krak225@gmail.com', 'richmond', NULL, NULL, 'Andore', 1, 6, '6.jpg', 'fr', 'Français', 'FCFA', 0, 500, 50, 0, 4, 5, 3, 0, 459900, 'richmond', '$2y$10$RSLmbj5y8mE4YK/BKsp/6.dSiZzTuqLL3FS564T9lBBJ2fQPA4JMS', 'YKU2O3H3fNW5H5zz2xQkjs0MVnQgdkpusuEnLkRMk84LiivashT4tPmrg0zK', NULL, NULL, '2019-03-08 21:31:43', '2022-03-05 00:44:36', 'VALIDE', 'ACTIVE', 'ACTIVE', 'Hors matrice', 'CONNECTE', 'Pro'),
...
--
ALTER TABLE `niveau`
  MODIFY `niveau_id` int(11) NOT NULL AUTO_INCREMENT;
