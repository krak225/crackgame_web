...
<ul class="breadcrumb no-border no-radius b-b b-light pull-in"> 
	...
	<li><a href="{{ route('categorie_test') }}"> Test de connaissance</a></li>  
...
<div class="panel panel-default page_test_connaissance" id="page_jeu"> 
	...
	<div class="wizard-steps clearfix" id="form-wizard"> 
		<ul class=""> 
			...
			<li class="active col-md-6" data-target="#step3"><span class=""><span class="badged">Total des points: </span><span class="badge bg-warning">{{ number_format(Auth::user()->total_points_test,0,'.',' ')}}</span></li>
		</ul> 
	</div> 
				...
				<div id="jeu"> 
					...
					<div id="StartView" style="display:none"> 
						<div style="padding:90px 0px;">
							<h4>Test de connaissance en {{$categorie->categorie_libelle}}</h4>
