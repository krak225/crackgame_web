...
-- Export de la structure de la table recensement_db. circonscription
CREATE TABLE IF NOT EXISTS `circonscription` (
  `circonscriptionID` int(11) NOT NULL,
  `typeDeCirconscriptionID` char(1) CHARACTER SET utf8 NOT NULL,
  `regionID` int(11) NOT NULL,
  `circonscriptionLibelle` varchar(254) DEFAULT NULL,
  `circonscriptionCode` varchar(254) DEFAULT NULL,
  `circonscriptionDescription` varchar(254) DEFAULT NULL,
  `circonscriptionStatut` enum('BROUILLON','VALIDE','SUPPRIME','CLOTURE') DEFAULT NULL,
  PRIMARY KEY (`circonscriptionID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Export de données de la table recensement_db.circonscription : ~2 rows (environ)
/*!40000 ALTER TABLE `circonscription` DISABLE KEYS */;
INSERT INTO `circonscription` (`circonscriptionID`, `typeDeCirconscriptionID`, `regionID`, `circonscriptionLibelle`, `circonscriptionCode`, `circonscriptionDescription`, `circonscriptionStatut`) VALUES
	(1, '1', 1, 'CIRCONSCRIPTION YOPOUGON', NULL, NULL, NULL),
	(2, '1', 1, 'CIRCONSCRIPTION ADJAME', NULL, NULL, NULL);
/*!40000 ALTER TABLE `circonscription` ENABLE KEYS */;
...
INSERT INTO `quartier` (`quartierID`, `circonscriptionID`, `quartierLibelle`, `quartierCode`, `quartierDescription`, `quartierStatut`) VALUES
...
-- Export de la structure de la table recensement_db. typedecirconscription
CREATE TABLE IF NOT EXISTS `typedecirconscription` (
  `typeDeCirconscriptionID` char(1) CHARACTER SET utf8 NOT NULL,
  `typeDeCirconscriptionLibelle` varchar(254) DEFAULT NULL,
  PRIMARY KEY (`typeDeCirconscriptionID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Export de données de la table recensement_db.typedecirconscription : ~0 rows (environ)
/*!40000 ALTER TABLE `typedecirconscription` DISABLE KEYS */;
/*!40000 ALTER TABLE `typedecirconscription` ENABLE KEYS */;
