...
<div class="panel panel-default"> 
	...
	<div class="step-content clearfix"> 
		<form enctype="multipart/form-data" id="form_add_question" method="post" class="form-horizontal" action="<?php echo e(route('SaveQuestion')); ?>">
			...
			<div class="step-pane active" id="step1"> 
				...
				<div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
					...
					<div class="col-md-4">
						<input placeholder="160 caractères maximum" maxlength="160" id="question_" type="text" class="form-control" name="question" value="<?php echo e(old('question')); ?>" required autofocus>
					</div>
