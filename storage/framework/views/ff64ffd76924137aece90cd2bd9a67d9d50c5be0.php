...
<ul class="breadcrumb no-border no-radius b-b b-light pull-in"> 
	...
	<li><a href="<?php echo e(route('categorie_test')); ?>"> Quiz</a></li>  
...
<div class="panel panel-default page_test_connaissance" id="page_jeu"> 
	...
	<div class="wizard-steps clearfix" id="form-wizard"> 
		<ul class=""> 
			...
			<li class="active col-md-6" data-target="#step3" style="display:none;"><span class=""><span class="badged">Total des points: </span><span class="badge bg-warning"><?php echo e(number_format(Auth::user()->total_points_test,0,'.',' ')); ?></span></li>
		</ul> 
	</div> 
		...
		<div id="ESPACEDEJEU">
			...
			<div class="col-md-2 text-center"> 
				...
				<div class="actions"> 
					...
					<button id="btnStartGame" data-objectif_financier="<?php echo e($objectif_financier); ?>" type="button" class="btn btn-info btn-sm pause"><i class="fa fa-play"></i> Démarer le quiz</button> 
				</div>
				...
				<div id="jeu"> 
					...
					<div id="StartView" style="display:none"> 
						<div style="padding:90px 0px;">
							<h4>Quiz en <?php echo e($categorie->categorie_libelle); ?></h4>
