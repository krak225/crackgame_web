		...
		<div id="ESPACEDEJEU">
			...
			<div class="col-md-2 text-center" id="boxJoueur2"> 
				...
				<div class="player_photo col-md-12" style="margin-top:3px;">
					...
					<img class="rounded" src="<?php echo e(asset('images/avatars/'. Auth::user()->photo )); ?>" alt="" style="width: 75px;" />
			...
			<div class="col-md-2 text-center" id="boxJoueur2"> 
				...
				<div class="player_photo col-md-12" style="margin-top:3px;">
					...
					<img class="rounded" src="<?php echo e(asset('images/avatars/'. $adversaire->photo )); ?>" style="width: 75px;"/>
