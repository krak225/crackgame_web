...
<div class="panel panel-default page_chap" id="page_jeu"> 
	...
	<div class="wizard-steps clearfix" id="form-wizard"> 
		<ul class=""> 
			...
			<!--li class="active col-md-4 text-center" data-target="#step3"><span class="badge" style="font-size: 24px;font-weight: bold;margin-top: 5px;display: none;">NIVEAU <?php echo e($chap->chap_etape); ?></span></li-->
		</ul> 
	</div> 
