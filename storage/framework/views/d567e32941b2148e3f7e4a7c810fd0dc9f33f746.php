...
<head> 
	...
	<link rel="stylesheet" href="<?php echo e(asset('js/flipclock/flipclock.min.css')); ?>" type="text/css"/>	
	<!--[if lt IE 9]> 
...
<body class=""> 
		...
		<div class="header row">
			...
			<div class="row container-fluid" id="top_bar">
               ...
               <div class="col-md-10" id="statData">
				 <?php if(auth()->guard()->check()): ?>
                 <div class="col-md-2 box row" ><span class="legend"><br/></span><span class="valeur"><?php echo e(Auth::user()->total_points_duel); ?></span><br/> <span class="legend">POINTS</span></div>
                 <!--div class="col-md-2 box row"><a href="<?php echo e(route('jocker_question')); ?>"><span class="legend"><br/></span><span class="valeur"><?php echo e(Auth::user()->jocker_question); ?></span><br/> <span class="legend">JOCKER QUESTION</span></a></div-->
                 <div class="col-md-2 box row" ><span class="legend"><br/></span><span class="valeur"><?php echo e(Auth::user()->jocker_duel); ?></span><br/> <span class="legend">JOKERS DUEL</span></div>
                 <div class="col-md-3 box row" ><span class="legend">AUJOURD'HUI<br/></span><span class="valeur red bold"><?php echo e(Stdfn::getTodayCagnotte()); ?></span><br/> <span class="legend">A GAGNER</span></div>
                 <div class="col-md-2 box row" ><a href="<?php echo e(route('souscription')); ?>"><span class="legend"><br/></span><span class="valeur"><?php echo e(Auth::user()->souscription); ?></span><br/> <span class="legend">SOUSCRIPTION</span></a></div>
                 <div class="col-md-2 box row" ><a href="<?php echo e(route('souscription')); ?>"><span class="legend"><br/></span><span class="valeur"><i class="fa fa-money"></i>
					<?php echo e(Auth::user()->devise . ' ' . number_format(Auth::user()->money, 0, '.', ' ')); ?></span><br/><span class="my_money" style="padding:5px 0px;display:block;font-weight:bold;"><span class="legend depot_retrait"><a href="<?php echo e(route('depot')); ?>">Dépot</a> | <a href="<?php echo e(route('retrait')); ?>">Retrait</a></span></span></div>
			...
			<nav class="container" style="width: 900px;margin:auto;">
			 ...
			 <ul id="top_menu" class="nav navbar-nav hidden-xs" style="margin:auto;width:100%;"> 
					...
					<ul class="dropdown-menu animated fadeInRight">
						...
						<li class="dropdown"><a class="dropdown-toggle dker" data-toggle="dropdown"  href="">Questionnaire</a>
							<ul class="dropdown-menu animated fadeInRight">
								...
								<li><a href="<?php echo e(route('questions','1')); ?>">Duel</a></li>
								<li><a href="<?php echo e(route('questions','1')); ?>">Chap</a></li>
							</ul>
						</li>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu animated fadeInLeft">
						<span class="arrow top"></span>
						<li><a href="<?php echo e(route('souscrirequiz')); ?>">Souscrire et jouer</a></li>	
						<li><a href="<?php echo e(route('quizs')); ?>">Afficher tout</a></li>	
					</ul>
	...
	<script src="<?php echo e(asset('js/flipclock/flipclock.min.js')); ?>"></script>
