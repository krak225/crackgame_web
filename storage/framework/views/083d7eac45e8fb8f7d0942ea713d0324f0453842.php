			...
			<?php $__currentLoopData = $chaps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<tr>
					...
					<?php if(Auth::user()->profil_id == 1): ?>
						<?php if($chap->chap_statut=='EN COURS' && $chap->readystate=='NOT READY'): ?>
						<span class="btnDemarerChap" data-chap_id="<?php echo e($chap->chap_id); ?>" data-admin_id="<?php echo e(Auth::user()->id); ?>" class="btn " style="cursor:pointer;">Démarer</span>
						<?php endif; ?>
					<?php else: ?>
